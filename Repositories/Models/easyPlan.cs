...
{
    public partial class easyPlan : DbContext
    {
        public easyPlan()
        {
        }

        public easyPlan(DbContextOptions<easyPlan> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Message>(entity =>
            {
                ...
                entity.HasOne(d => d.FromUserNavigation)
                    ...
                    .HasConstraintName("FK__Message__fromUse__2E1BDC42");

                entity.HasOne(d => d.ToUserNavigation)
                    .WithMany(p => p.MessageToUserNavigation)
                    .HasForeignKey(d => d.ToUser)
                    .HasConstraintName("FK__Message__toUser__2F10007B");
            });
            ...
            modelBuilder.Entity<Program>(entity =>
            {
                ...
                entity.HasOne(d => d.ProgramerNavigation)
                    ...
                    .HasConstraintName("FK__Program__program__398D8EEE");
